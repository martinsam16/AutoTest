...
public class main {
    ...
    public static void main(String[] args) throws ClassNotFoundException, InstantiationException, IOException {
        ...
        GTest test = new GTest(DemoImpl.class, Demo.class);
        test.ejecutarMetodos();

        //Pruebas para obtener instancias de las clases
//        main de = new main();
//        for (Class c : de.getClasses("dao")) {
